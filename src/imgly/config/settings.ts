...
export function setupSettings(engine: CreativeEngine): void {
  ...
  // Allow editing page titles directly on canvas
  ...
  // ============================================================================
  // GRID SETTINGS
  // Configure background grid and snap-to-grid for precise alignment
  // ============================================================================

  // #region Grid Settings
  // Enable background grid for visual alignment reference
  // engine.editor.setSetting('grid/enabled', true);

  // Enable snap-to-grid for precise block positioning
