...
export function setupFeatures(cesdk: CreativeEditorSDK): void {
  cesdk.feature.enable([
    ...
    'ly.img.text.list' /* List formatting parent */,
    'ly.img.text.list.unordered' /* Unordered (bullet) lists */,
    'ly.img.text.list.ordered' /* Ordered (numbered) lists */,
    ...
    'ly.img.page.settings' /* Page settings panel */,
    'ly.img.page.bleedMargin' /* Bleed margin controls */,
    // #endregion

    // ============================================================================
    // SCENE LAYOUT FEATURES
    // Configure scene layout modes
    // ============================================================================

    // #region Scene Layout Features
    'ly.img.scene.layout' /* Scene layout parent feature */,
    ...
    'ly.img.shape.edit' /* Shape edit mode */,
    ...
    // Configure vector path editing capabilities
    // ============================================================================

    // #region Vector Edit Features
    'ly.img.vectorEdit' /* Vector edit mode parent */,
    'ly.img.vectorEdit.moveMode' /* Move points mode */,
    'ly.img.vectorEdit.addMode' /* Add points mode */,
    'ly.img.vectorEdit.deleteMode' /* Delete points mode */,
    'ly.img.vectorEdit.bendMode' /* Bend curves mode */,
    'ly.img.vectorEdit.mirrorMode' /* Mirror points mode */,
    'ly.img.vectorEdit.done' /* Done editing button */,
    // #endregion

    // ============================================================================
    // RULERS FEATURES
    // Configure canvas rulers
    // ============================================================================

    // #region Rulers Features
    ...
    // 'ly.img.placeholder.audio', /* Audio section (for audio blocks) */
    ...
    // 'ly.img.video.timeline.ruler', /* Timeline ruler visibility */
